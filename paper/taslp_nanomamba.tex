...
Notably, with SS+Bypass, NanoMamba (4,957 params) surpasses BC-ResNet-1 (7,464 params) in extreme-SNR average accuracy on 3 of 5 noise types: white (+5.2\,\%p), street (+3.0\,\%p), and pink (+0.7\,\%p)---despite having 1.5$\times$ fewer parameters.
