...
\textit{Results to be populated after CULane training.}
...
\begin{tabular}{@{}lrrl@{}}
\toprule
\textbf{Model} & \textbf{Params} & \textbf{INT8} & \textbf{MACs} \\
\midrule
...
\midrule
\textbf{NC-SSM-Tiny} & \textbf{25K} & \textbf{24\,KB} & -- \\
NC-SSM-Small & 33K & 32\,KB & -- \\
\bottomrule
\multicolumn{4}{l}{\scriptsize NC-SSM: $100{\times}$ fewer params than smallest baseline.}
\end{tabular}
\end{table}
